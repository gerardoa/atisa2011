...
public class ThermometerService extends Service {
   ...
   * @throws Exception
   */
  public ThermometerService(String gatewayLocation, String thisLocation) 
    throws Exception {
    super(thisLocation);
    URL url = new URL(thisLocation);
    Invoker.invoke(gatewayLocation, "registerThermometer", "location", 
                   url.toString());
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (int i = 0; i < Integer.parseInt(args[2]); i++) {
      String location = "http://" + baseUrl.getHost() + ":" + 
        (baseUrl.getPort() + i) + "/";
